...
που προτείνεται από αυτό το paper https://maverick.inria.fr/~Prashant.Goswami/Research/Papers/VRIPHYS11_TAASPH.pdf για την κλιμάκωσή του όταν αυτό επιτρέπεται
...
Εν τέλει δεν υλοποιήθηκε το adaptive smoothing length καθώς για αυτές τις εφαρμογές και συνθήκες προβλήματος δεν κρίθηκε 
απαραίτητο και θα προσέθετε πολυπλοκότητα στον κώδικα και δαπάνη στη ταχύτητα εκτέλεσης. 
