...
def WgradW(x, y, z, h, r, neighbors):
    """
...
def getDensity(r, pos, m, h, tree):
    ...
    """
    dx, dy, dz, r, neighbors = getPairwiseSeparations(r, pos, tree)
    w = WgradW(dx, dy, dz, h, r, neighbors)[0]
...
def getAcc(pos, vel, m, h, k, n, lmbda, nu, tree):
    ...
    dx, dy, dz, r, neighbors = getPairwiseSeparations(pos, pos, tree)
    dWx, dWy, dWz = WgradW(dx, dy, dz, h, r, neighbors)[1:]
...
def main():
    ...
    print("Dimensional kdtree v1.0 with cubic spline kernel N = " + str(N) + " - Runtime was: " + str(end-start))
