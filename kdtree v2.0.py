...
def getAcc(pos, vel, m, h, k, n, lmbda, nu, tree):
    ...
    dWx, dWy, dWz = gradW(dx, dy, dz, r, h, neighbors)
...
def main():
    ...
    print("Dimensional kdtree v2.0 with cubic spline kernel N = " + str(N) + " - Runtime was: " + str(end-start))
